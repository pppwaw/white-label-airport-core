...
const (
	...
	Core_GetHiddifySettings_FullMethodName    = "/hiddifyrpc.Core/GetHiddifySettings"
	...
	Core_GetConfigCapabilities_FullMethodName = "/hiddifyrpc.Core/GetConfigCapabilities"
...
type CoreClient interface {
	...
	GetHiddifySettings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HiddifySettingsResponse, error)
	...
	GetConfigCapabilities(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ConfigCapabilityResponse, error)
...
func (c *coreClient) GetHiddifySettings(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HiddifySettingsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HiddifySettingsResponse)
	err := c.cc.Invoke(ctx, Core_GetHiddifySettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *coreClient) GetConfigCapabilities(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ConfigCapabilityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfigCapabilityResponse)
	err := c.cc.Invoke(ctx, Core_GetConfigCapabilities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	GetHiddifySettings(context.Context, *Empty) (*HiddifySettingsResponse, error)
	// rpc GenerateConfig (GenerateConfigRequest) returns (GenerateConfigResponse);
	...
	GetConfigCapabilities(context.Context, *Empty) (*ConfigCapabilityResponse, error)
...
func (UnimplementedCoreServer) GetHiddifySettings(context.Context, *Empty) (*HiddifySettingsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHiddifySettings not implemented")
}
...
func (UnimplementedCoreServer) GetConfigCapabilities(context.Context, *Empty) (*ConfigCapabilityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetConfigCapabilities not implemented")
}
...
func _Core_GetHiddifySettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).GetHiddifySettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_GetHiddifySettings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).GetHiddifySettings(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_GetConfigCapabilities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).GetConfigCapabilities(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_GetConfigCapabilities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).GetConfigCapabilities(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHiddifySettings",
			Handler:    _Core_GetHiddifySettings_Handler,
		},
		{
		...
		{
			MethodName: "GetConfigCapabilities",
			Handler:    _Core_GetConfigCapabilities_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
